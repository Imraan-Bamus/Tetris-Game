...
// Add this function at the bottom of your main.js file
function clearHighScores() {
  localStorage.removeItem('highScores');
  showHighScores(); // Refresh the displayed high scores
}
// Add this function at the bottom of your main.js file
...
function exitGame() {
  // Any cleanup or additional actions before exiting the game can be added here
  // For example, you might want to stop any background sounds or animations.

  // Close the game window or redirect to another page.
  window.close(); // Note: This might not work in some browsers due to security restrictions.
}
